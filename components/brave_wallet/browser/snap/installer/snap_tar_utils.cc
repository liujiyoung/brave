...
// Rejects absolute paths and any path containing a ".." component. Entry names
// are attacker controlled and entry contents are later written to disk.
...
// remainder is unsafe.
std::optional<std::string_view> ToSnapRelativePath(std::string_view entry_path) {

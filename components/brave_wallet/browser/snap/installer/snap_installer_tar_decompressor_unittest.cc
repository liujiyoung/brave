...
TEST_F(SnapInstallerTarDecompressorTest, ManifestWithoutBundlePathReturnsError) {
...
TEST_F(SnapInstallerTarDecompressorTest, OversizedDecompressedSizeReturnsError) {
  const std::string bundle = "export const onRpcRequest = () => 42;";
  std::string gz = BuildSnapTarball(
